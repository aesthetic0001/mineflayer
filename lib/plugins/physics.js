...
function inject (bot, { physicsEnabled, maxCatchupTicks }) {
  ...
  // rewrote these according to https://github.com/Marcelektro/MCP-919/blob/main/src/minecraft/net/minecraft/network/play/client/C03PacketPlayer.java, doesn't seem like onGround is sent in 1.8.9
  // other unnecessary things were also being passed (the whole lastSent obj)
  ...
  function updatePosition () {
    ...
    const positionUpdated = lastSent.x !== position.x || lastSent.y !== position.y || lastSent.z !== position.z || positionUpdateTicks >= 20
